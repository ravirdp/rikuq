...
- **[Anthropic prompt caching: real numbers from production](/blog/infra/anthropic-prompt-caching-real-numbers)** *(coming soon)* — how to cut Claude bills 35-45%
- **[How I built Citare in 12 days with Claude Code](/case-studies/citare)** *(coming soon)* — the case study showing this stack in action at velocity
