...
- **[Cursor vs Claude Code: which to buy first](/blog/tools/cursor-vs-claude-code)** — the head-to-head for solo founders.
- **[How I built Citare in 12 days with Claude Code](/case-studies/citare)** *(coming soon)* — the case study proving the velocity claim.
- **[Anthropic prompt caching: real numbers from production](/blog/infra/anthropic-prompt-caching-real-numbers)** — making the $200 plan even more efficient.
