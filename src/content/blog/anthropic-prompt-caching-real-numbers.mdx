...
5. **Read [What is LLM FinOps?](/blog/finops/what-is-llm-finops)** for the broader framework these numbers fit inside.

## Related reading

- **[What is LLM FinOps?](/blog/finops/what-is-llm-finops)** — the broader framework these caching numbers fit inside
- **[The FinOps Foundation Framework: A Practitioner's Walkthrough](/blog/finops/finops-foundation-framework-2026)** — where prompt caching sits in the Optimize phase
- **[Why LLM Gateway Attribution Is Harder Than Cloud FinOps Ever Was](/blog/finops/llm-gateway-attribution-harder-than-cloud-finops)** — the attribution layer behind cache-hit accounting
