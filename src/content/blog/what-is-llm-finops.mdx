...
I'm Ravi. I run three production AI SaaS solo — [Prism](https://ssimplifi.com) (an AI gateway with caching + FinOps controls built in), [Citare](https://citare.ai), [BatchWise](https://batchwise.ai) — and an advisory practice doing this work professionally for mid-market Indian companies at [rikuq services](/services). I write both sides: the technical implementation and the financial structure. That's the gap LLM FinOps lives in.
...
This is exactly the gap I work in at [rikuq services](/services). I'm a builder who shipped three production AI SaaS at scale; the technical optimization comes from doing the work, not from reading about it. I'm also building toward the Indian regulatory side — SEBI's January 2026 AI disclosure mandates, GST input tax credit on cloud and AI spend, Section 195 TDS on foreign AI vendor payments — because the technical optimization without the financial structure leaves money on the table.
...
- Pick a gateway/observability layer. [Prism vs Portkey vs Helicone vs LiteLLM vs OpenRouter comparison post](/blog/infra/portkey-vs-helicone-vs-litellm-vs-openrouter) — until then, the short version: Portkey for observability-first, Helicone for clean logging, [Prism (my own)](https://ssimplifi.com) for measured savings + edge cache + governance unified.
...
- Either build the internal function or engage outside advisory. The evolving Indian AI-governance frame (DPDP Act 2023, ICAI voluntary AI assurance guidance, and SEBI's June 2025 AI/ML consultation paper — applicable today to MIIs, intermediaries, and mutual funds, still in consultation for the broader market) makes the documentation side increasingly expected regardless.
- For context on the Indian regulatory layer + the optimization side together, my advisory practice at [rikuq services](/services) covers exactly this. Free 30-minute discovery call if useful.
...
**The FinOps frameworks and mechanics:**

- **[The FinOps Foundation Framework: A Practitioner's Walkthrough](/blog/finops/finops-foundation-framework-2026)** — the reference architecture this discipline is built on (phases, capabilities, 2026 updates)
- **[FinOps vs ITFM vs ITAM: Why You Eventually Need All Three](/blog/finops/finops-vs-itfm-vs-itam-2026)** — where LLM FinOps sits relative to the adjacent cost disciplines
- **[Why LLM Gateway Attribution Is Harder Than Cloud FinOps Ever Was](/blog/finops/llm-gateway-attribution-harder-than-cloud-finops)** — the attribution layer that's the hardest part of the discipline
- **[AI Cost Allocation: Models That Work in Indian Production](/blog/finops/ai-cost-allocation-india-2026)** — showback vs chargeback, dimensions, tag enforcement

**The Indian regulatory + tax layer:**

- **[AI Systems Review: A 6-Domain Framework You Can Run Internally](/blog/finops/ai-systems-review-framework-india-2026)** — the operational + governance review framework
- **[AI Tax Recovery for Indian CFOs: The 5-Domain Framework](/blog/finops/ai-tax-recovery-framework-india-2026)** — GST ITC, Section 195, RCM, capex/opex, transfer pricing
- **[AI / Cloud FinOps Providers in India: A Practitioner's Take](/blog/finops/ai-cloud-finops-providers-india-2026)** — who fits what at the provider-selection layer

**The optimization data + stack:**
...
- **[Portkey vs Helicone vs LiteLLM vs OpenRouter](/blog/infra/portkey-vs-helicone-vs-litellm-vs-openrouter)** — the gateway/observability landscape
- **[rikuq services](/services)** — the advisory practice for mid-market Indian companies needing this done professionally
